...
class SosRepository {
  ...
  String? _extractUserIdFromToken(String token) {
    try {
      ...
      final possibleKeys = [
        'sub', 'user_id', 'userId', 'id', 'nameid', 'unique_name'
      ];
  ...
  String? getUserName() {
    final possibleKeys = [
      "user_name_from_token", "user_email_from_token",
      ApiKey.name, "fullname", "name", "username", "displayName",
      "firstName", "lastName", "user_name", "userName", "display_name",
      "full_name", ApiKey.email, "email"
    ];
  ...
  String? _extractUserInfoFromToken() {
    try {
      ...
      final possibleNameClaims = [
        'name', 'fullname', 'given_name', 'family_name',
        'preferred_username', 'username', 'unique_name', 'display_name'
      ];
